...
class PetGroupMedicalControllerTest extends BaseControllerTest {
    ...
    void findGroupMedicalStatistics() {
        ...
        PetMedicalStatisticsResponse response = given().log().all()
                .contentType(ContentType.JSON)
                .header(HttpHeaders.AUTHORIZATION, BEARER_PREFIX  + accessToken)
                .queryParam("disease", "DER")
                ...
                .statusCode(200)
                .extract()
                .as(PetMedicalStatisticsResponse.class);

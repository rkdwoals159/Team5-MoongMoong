      ...
      return (
        <div className="flex items-start gap-600">
          <button
            ...
            className="rounded-250 border border-(--color-border-normal) px-400 py-200 typo-body-m-medium text-(--color-text-base)"
          >
            모달 열기
          </button>
          <Modal {...args} open={open}>
            <div className="flex items-center justify-between px-600 pt-600">
              <h2 id={titleId} className="typo-title-m-bold text-(--color-text-base)">
                모달 타이틀
              </h2>
              <button
                type="button"
            ...
            <div className="px-600 pb-700 pt-400">
              <p className="typo-body-m-regular text-(--color-text-base)">
              ...
              <div className="mt-600 flex justify-end">
                <button
                  type="button"
                  onClick={() => setOpen(false)}
                  className="rounded-250 border border-(--color-border-normal) px-400 py-200 typo-body-m-medium text-(--color-text-base) cursor-pointer"
                >
                  확인
                </button>
              </div>

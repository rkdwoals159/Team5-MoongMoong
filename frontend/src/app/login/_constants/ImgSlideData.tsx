...
export const slides = [
  {
    image: <ImgOnboarding1 aria-hidden width={790} height={896} className="h-full w-full" />,
    alt: "온보딩 이미지 1",
    title: ["가족이 함께 쓰는", "우리 강아지 가계부"],
  },
  {
    image: <ImgOnboarding2 aria-hidden width={790} height={896} className="h-full w-full" />,
    alt: "온보딩 이미지 2",
    title: ["우리 강아지 소비 흐름을", "한 눈에"],
  },
  {
    image: <ImgOnboarding3 aria-hidden width={790} height={896} className="h-full w-full" />,
    alt: "온보딩 이미지 3",
